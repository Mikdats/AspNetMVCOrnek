    ...
    public class HomeController : Controller
    {
        ...
        public JsonResult OgrenciBilgileri(int id)
        {
            try
            {
                ...
                {
                    throw new Exception("id parametresi düzgün verilmelidir.");
                }
            }
            catch (Exception ex)
            {
        ...
        public ActionResult OgrenciGuncelle(Student model)
        {
            try
            {
                ...
                if (student==null)
                {
                    throw new Exception("Öğrenci bulunmadı.");
                }
            ...
            {
                TempData["OgrenciGuncelleHataMesaji"] = "Beklenmedik bir hata oluştu. Hata:" + ex.Message;
                return RedirectToAction("Index", "Home");
